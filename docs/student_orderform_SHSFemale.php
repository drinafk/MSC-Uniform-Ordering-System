...
<html lang="en">
  ...
  <body class="body2">
    ...
    <table class="table">
      ...
      <tr>
        ...
        <td class="border"><input name="type" value="SHS Uniform" id="type"><p>SHS Uniform</p></td>
      </tr>
      <tr>
  ...
  <div class="leftpanellogos">
      ...
      <div class="back_orderform">
          <a href="student_femaleshspreview.php"><button>Back</button></a>
      </div>
      <div class="dots3">
