...
<html lang="en">
  ...
  <body class="body1">
    ...
    <p class="newordertag">On Process</p>
    <div class="container">
    <table class="ordertable">
            ...
            <?php
              ...
              $sql = "SELECT * FROM orderdb WHERE status = 'ON PROCESS' ORDER BY name ASC";
              ...
              //COLLEGE/SHS
                    ...
                    echo "<tr>
                                ...
                                <td>$balance</td>
                                <td>
                                    <button class='verifyBtn' name = 'status' onclick='toFinished($row[id], $i)'>Move to Finished</button>
                                </td>
                          </tr>";
                  }
              }
    ...
    <script>
       function toFinished(id, i){
        Mail(id);
            $.ajax({
            url: 'finished_order.php',
            type: 'post',
            data: {verify_id: id},
            success: function(result){
              alert('Order No. ' + i + ' Moved To Finished');
              document.location='onprocess.php';
            }
        });
