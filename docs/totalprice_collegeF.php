...
if($_POST["top_quantity"] != "" && $_POST["bottom_quantity"] != "" && $_POST["necktie"] != ""){
    switch($_POST["top_size"]){
        //College/SHS
                    case "S14":
                        $total1 = $_POST["top_quantity"] * 400;
                      break;
                    case "S15":
                        $total1 = $_POST["top_quantity"] * 450;
                      break;
                    case "S16":
                        $total1 = $_POST["top_quantity"] * 500;
                      break;
                    case "S17":
                        $total1 = $_POST["top_quantity"] * 550;
                      break;
                    case "S18+":
                        $total1 = $_POST["top_quantity"] * 600;
                      break;
                  }
                  switch($_POST["bottom_size"]){
                    case "S24":
                        $total2 = $_POST["bottom_quantity"] * 400;
                      break;
                    case "S25":
