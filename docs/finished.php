...
<html lang="en">
  ...
  <body class="body1">
    ...
    <p class="newordertag">Finished orders</p>
    <div class="container">
    <table class="ordertable">
            ...
            <?php
              ...
              $sql = "SELECT * FROM orderdb WHERE status = 'FINISHED' ORDER BY name ASC";
              ...
              //COLLEGE/SHS
                    ...
                    echo "<tr>
                                ...
                                <td>$balance</td>
                                <td>
                                    <button class='verifyBtn' name = 'status' onclick='toClaimed($row[id], $i)'>Move to Claimed</button>
                                </td>
                          </tr>";
                  }
              }
    ...
    <script>
       function toClaimed(id, i){
            $.ajax({
            url: 'claimed_order.php',
            type: 'post',
            data: {verify_id: id},
            success: function(result){
              alert('Order No. ' + i + ' Has Been Claimed');
