  ...
  <body class="body7">
    ...
    <div class="gradient"></div>
      <div class="leftpanel">
        ...
        <a href="student_shop.php"><p class="shop">Shop</p></a>
        <a href="student_howtoorder.php"><p class="howtoorder1">How to order</p></a>
    ...
    <div class="howtoorderimg">
      <img src="images/howtoorder.jpg">
    </div>
