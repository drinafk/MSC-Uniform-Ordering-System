...
<html lang="en">
  ...
  <body class="body1">
    ...
    <p class="newordertag">Verified orders</p>
    <div class="container">
    <table class="ordertable">
            ...
            <?php
              ...
              $sql = "SELECT * FROM orderdb WHERE status = 'VERIFIED' ORDER BY name ASC";
              ...
              //COLLEGE/SHS
                    ...
                    echo "<tr>
                                ...
                                <td>$balance</td>
                                <td>
                                    <button class='verifyBtn' name = 'status' onclick='toOnProcess($row[id], $i)'>Move to On Process</button>
                                </td>
                          </tr>";
                  }
              }
    ...
    <script>
       function toOnProcess(id, i){
            $.ajax({
            url: 'process_order.php',
            type: 'post',
            data: {verify_id: id},
            success: function(result){
              alert('Order No. ' + i + ' Moved To On Process');
              document.location='verified.php';
            }
        });
      }
    </script>
