...
<html lang="en">
  ...
  <body class="body4">
    ...
    <table class="table">
      ...
      <tr>
        ...
        <td class="border"><input name="gender" value="Male" id="gender"><p>Male</p></td>
      </tr>
      <tr>
        <td class="border2">Size (Polo):</td>
        <td class="border1">
  ...
  <div class="leftpanellogos">
      ...
      <div class="back_orderform">
          <a href="student_malecollegepreview.php"><button>Back</button></a>
      </div>
      <div class="dots3">
