  ...
  <body class="body4">
    ...
    <div class="gradient"></div>
      ...
      <div class="uniformBtn">
        <a href="student_malecollegepreview.php"><button class="male">Male</button></a>
        <a href="student_femalecollegepreview.php"><button class="female">Female</button></a>
      </div>
      <img class="maleicon" src="images/male.png">
      <img class="femaleicon" src="images/female.png">
