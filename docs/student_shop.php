...
<html lang="en">
  ...
  <body class="body1">
    ...
    <div class="gradient"></div>
      ...
      <div class="uniformBtn">
        <a href="student_selectgendershs.php"><button class="shs">SHS Uniform</button></a>
        <a href="student_shspepreview.php"><button class="shspe">SHS PE Uniform</button></a>
        <a href="student_selectgendercollege.php"><button class="college">College Uniform</button></a>
        <a href="student_collegepepreview.php"><button class="collegepe">College PE Uniform</button></a>
      </div>
