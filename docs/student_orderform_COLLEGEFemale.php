...
<html lang="en">
  ...
  <body class="body4">
    ...
    <div class="gradient"></div>
      ...
      <form method="dialog" id="order-form" class="orderform1" action="post">
    <table class="table">
      <tr>
      ...
      <tr>
        ...
        <td class="border"><input name="type" value="College Uniform" id="type"><p>College Uniform</p></td>
      </tr>
      <tr>
        <td class="border2">Gender:</td>
        <td class="border"><input name="gender" value="Female" id="gender"><p>Female</p></td>
      </tr>
      <tr>
        <td class="border2">Size (Blouse):</td>
        <td class="border1">
      ...
      <tr>
        <td class="border2">Size (Skirt):</td>
        <td class="border1">
      ...
      <tr>
        <td class="border2">Necktie:</td>
        <td class="orderform_bg"><input type="number" name="necktie" id="necktie" min="0" value="0" required></td>
      </tr>
      <tr>
    ...
    <button class="submitBtn" type="submit" id="placeorder" onclick="addorder()">Place Order</button></td>
  </form>
  <div class="leftpanellogos">
      ...
      <div class="back_orderform">
          <a href="student_femalecollegepreview.php"><button>Back</button></a>
      </div>
      <div class="dots3">
...
const course = document.getElementById('course_year_section');
